...
class RTMPoseProcessor(BaseProcessor):
    ...
    def __init__(self, processor_id: str, config_dict: Optional[Dict[str, Any]] = None):
        ...
        self.openpose_skeleton = pose_processor_config['openpose_skeleton']
        self.mode = pose_processor_config['mode']
        self.backend = pose_processor_config['backend']
        self.device = pose_processor_config['device']
